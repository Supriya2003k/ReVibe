...
<head>
    ...
    <title>Facility Profile - Batteries Recycling Facilities</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <div class="facility-profile" id="facilityProfile">
            ...
            $sql = "SELECT * FROM `recycle` WHERE `batteries` = 'yes'";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<p><strong>Accepted Materials:  </strong>Batteries</p>"."</br>";
