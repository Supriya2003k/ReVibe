...
<head>
    ...
    <title>Facility Profile - Electronics Recycling Facilities</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <div class="facility-profile" id="facilityProfile">
            ...
            $sql = "SELECT * FROM `recycle` WHERE `electronics` = 'yes'";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<p><strong>Accepted Materials:  </strong> Electronics</p>"."</br>";
